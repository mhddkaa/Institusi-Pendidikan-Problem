...
st.markdown("Aplikasi ini akan memprediksi apakah mahasiswa berpotensi **Dropout** atau **Graduate** berdasarkan data akademik dan demografi.")
...
with col1:
    ...
    Application_mode_label = st.selectbox(
        ...
        index=7, 
        help="Pilih jalur masuk mahasiswa. Gunakan 'General Phase 2 (17)' jika tidak yakin"
    )
